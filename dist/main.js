...
module.exports = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<h1>");t.b(t.v(t.f("header",c,p,0)));t.b("</h1>");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "<h1>{{header}}</h1>\n", Hogan);
},{"hogan.js":2}]},{},[4]);
